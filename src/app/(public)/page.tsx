  ...
  return (
    <main className={styles.main}>
      <section className={styles.bannerContainer}>
        <Typography variant='heading1' size='3xl' weight='semiBold' className={styles.title}>
        ...
        <div className={styles.buttonsWrapper}>
          <ButtonLink href='/register' variant='contained' color='cta' className={styles.button}>
            Abrir conta
          </ButtonLink>

          <ButtonLink href='/login' variant='outlined' color='cta' className={styles.button}>
            Já tenho conta
          </ButtonLink>
        </div>
      </section>
